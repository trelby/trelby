...
class WatermarkDlg(wx.Dialog):
    ...
    # prefix - prefix name for the PDFs.
    def __init__(self, parent, sp, prefix = ""):
        ...
        hsizer.Add((1, 1), 1)
        okBtn = wx.Button(self, -1, "Generate PDFs")
        hsizer.Add(okBtn, 0)
    ...
    def OnOK(self, event):
        ...
        wx.MessageBox("Generated %d files in directory %s." %
                     (len(watermarks), directory),"PDFs generated",
                     wx.OK, self)
